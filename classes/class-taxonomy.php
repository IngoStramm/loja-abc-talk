...
class LABCT_Taxonomy
{
    ...
    protected function labels()
    {
        $default = array(
            ...
            'add_or_remove_items'        => sprintf(__('Add or Remove %ss', 'labct'), $this->name),
            ...
            'parent_item'                => sprintf(__('Parent %s:', 'labct'), $this->name),
            ...
            'new_item_name'              => sprintf(__('New %s', 'labct'), $this->name),
            'all_items'                  => sprintf(__('All %ss', 'labct'), $this->name),
            'separate_items_with_commas' => sprintf(__('Separate %ss with comma', 'labct'), $this->name),
            'choose_from_most_used'      => sprintf(__('Choose from %ss most used', 'labct'), $this->name)
        );
