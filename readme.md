...
- Loja ABC Talk (Nome do plugin)
- labct (nome dos arquivos, nome do text domain e slug da url do repositório)
- LABCT_ (prefixo usado nas constantes de Url e diretório do plugin, além das classes)
- labct_ (prefixo usado nas funções)
...
- [WP Update Server](https://github.com/YahnisElsts/wp-update-server): API que verifica e aplica atualizações do Loja ABC Talk, através do próprio sistema de atualizações do WordPress
